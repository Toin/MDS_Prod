...
Imports Maruni_Production.MIS_Utils
...
Public Class SOToMFG
    ...
    Public Sub New()
        ...
        If Not Maruni_Production.SBOConnection.SBOApplication Is Nothing And Not Maruni_Production.SBOConnection.SBOCompany Is Nothing Then
            SBO_Application = Maruni_Production.SBOConnection.SBOApplication
            oCompany = Maruni_Production.SBOConnection.SBOCompany
